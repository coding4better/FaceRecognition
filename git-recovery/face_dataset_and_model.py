...
class Model:
    ...
    MODEL_PATH = './5person_model.face.model.h5'
...
if __name__ == '__main__':
    dataset = Dataset('./myface/images/')
    dataset.load()
    print(1, type(dataset))
    print('dataset.input_shape', dataset.input_shape)
...
if __name__ == '__main__':
    dataset = Dataset(r'./myface/images/')
    dataset.load()
    ...
    model.train(dataset)
    print('dataset.input_shape', dataset.input_shape)
    model.save_model(file_path='F:/study/project/face/myface/model/5person_model.face.model.h5')
...
if __name__ == '__main__':
    ...
    # 评估模型
    model = Model()
    model.load_model(file_path='F:/study/project/face/myface/model/5person_model.face.model.h5')
    model.evaluate(dataset)

# 改动：路径4处，类别数nb_classes2处
